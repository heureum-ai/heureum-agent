...
let _libxmljs: typeof import("libxmljs2") | null | undefined = undefined;
async function getLibxmljs(): Promise<typeof import("libxmljs2") | null> {
  if (_libxmljs !== undefined) return _libxmljs;
  try {
    _libxmljs = await import("libxmljs2");
  } catch {
    _libxmljs = null;
  }
  return _libxmljs;
