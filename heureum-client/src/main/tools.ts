import { CODING_TOOLS, handleCodingTool } from '@heureum/coding'

export { handleCodingTool }

/** The 6 non-bash coding tools (read, edit, write, grep, find, ls) */
export const NON_BASH_CODING_TOOLS = CODING_TOOLS.filter(t => t.name !== 'bash')
